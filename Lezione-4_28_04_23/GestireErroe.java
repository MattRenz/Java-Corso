...
public class GestireErroe {
	static public void main(String[] args) /*throws IOException*/{
		...
		BufferedReader br = new BufferedReader(new InputStreamReader(System.in)); // gestisce la tastiera in modo flessibile
	
        // classe             // istanza classe

        System.console().readLine(); // per leggere da terminale, direttamente dalla console

        // se in java mi chiamo una funzione che ptorebbe andare in errore, il programma non compila
